...
public class UserService {
    ...
    public UserResponse updateUserProfile(Long id, User userDetails) {
        User user = getUserById(id);
        ...
        // Don't allow password change through this endpoint for security
        // Password should be changed through /api/auth/change-password
